...
print('Лампа -',store[goods['Лампа']][0]['quantity'] + store[goods['Лампа']][0]['quantity'] ,
      'шт, стоимость', lamps_cost, 'руб')

table_cost = store[goods['Стол']][0]['quantity'] * store[goods['Стол']][0]['price']
table_cost2 = store[goods['Стол']][0]['quantity'] * store[goods['Стол']][0]['price']

print('Стол -',store[goods['Стол']][0]['quantity'] + store[goods['Стол']][1]['quantity'] ,
      'шт, стоимость', table_cost + table_cost2, 'руб')

div_cost = store[goods['Диван']][0]['quantity'] * store[goods['Диван']][0]['price']
div_cost_2 = store[goods['Диван']][1]['quantity'] * store[goods['Диван']][1]['price']

print('Диван -',store[goods['Диван']][0]['quantity'] + store[goods['Диван']][1]['quantity'] ,
      'шт, стоимость', div_cost + div_cost_2, 'руб')
...
print('Стул -',store[goods['Стул']][0]['quantity'] + store[goods['Стул']][1]['quantity'] ,
      'шт, стоимость', chair_cost + chair_cost_2 + chair_cost_3, 'руб')
