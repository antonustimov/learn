...
for y in range(0, 600, 50):
    ...
    sd.line(start_point=horisontal_start_point, end_point=horisontal_end_point, color=sd.COLOR_RED, width=2)
    for x in range(1, 1200, 100):
        ...
        sd.line(start_point=vertical_start_point, end_point=vertical_end_point, color=sd.COLOR_RED, width=2)
